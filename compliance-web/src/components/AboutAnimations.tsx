...
export default function AboutAnimations() {
    ...
    useLayoutEffect(() => {
        ...
        const ctx = gsap.context(() => {
            ...
            gsap.from(
                ".platform-info .h4, .platform-info p, .platform-info .platform-lists",
                {
                    opacity: 0,
                    x: 100,
                    delay: 1,
            ...
            gsap.from(".platform-info .platform-btn", {
                opacity: 0,
                scale: 0,
                delay: 4,
                duration: 1,
            ...
            gsap.from(".core-feature-heading .h4, .core-feature-heading p", {
                opacity: 0,
                y: -50,
                delay: 1,
                duration: 1,
